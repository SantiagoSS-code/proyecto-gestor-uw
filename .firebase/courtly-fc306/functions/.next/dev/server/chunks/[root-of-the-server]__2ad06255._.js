...
"[project]/app/api/backoffice/centers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const [centersSnap, legacySnap, courtsSnap] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestorePaths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FIRESTORE_COLLECTIONS"].centers).limit(200).get(),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestorePaths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FIRESTORE_COLLECTIONS"].legacyCenters).limit(200).get(),
        ...
        for (const doc of courtsSnap.docs){
            ...
            const entry = courtsByCenter.get(centerId) || {
                count: 0,
                sports: new Set()
            };
            entry.count += 1;
        ...
        const filtered = q ? items.filter((c)=>{
            ...
            return name.includes(q) || email.includes(q) || ownerEmail.includes(q) || slug.includes(q) || String(c.centerId).includes(q);
        }) : items;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ad06255._.js.map