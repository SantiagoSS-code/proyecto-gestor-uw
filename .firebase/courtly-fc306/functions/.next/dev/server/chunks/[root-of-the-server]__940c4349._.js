...
"[project]/app/api/backoffice/players/[uid]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const userRef = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection("users").doc(uid);
        ...
        try {
            const playerSnap = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection("players").doc(uid).get();
        ...
        let bookings = [];
        try {
            const bookingsSnap = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collectionGroup("bookings").where("userId", "==", uid).orderBy("createdAt", "desc").limit(50).get();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__940c4349._.js.map