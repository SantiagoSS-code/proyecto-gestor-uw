...
"[project]/lib/firestorePaths.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/backoffice/courts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestorePaths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/firestorePaths.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
async function GET(request) {
    try {
        ...
        const [centersSnap, legacySnap, courtsSnap] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestorePaths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FIRESTORE_COLLECTIONS"].centers).get(),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestorePaths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FIRESTORE_COLLECTIONS"].legacyCenters).get(),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collectionGroup(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestorePaths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CENTER_SUBCOLLECTIONS"].courts).get()
        ]);
        const centersMap = new Map();
        for (const doc of legacySnap.docs){
            centersMap.set(doc.id, {
                centerId: doc.id,
                source: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestorePaths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FIRESTORE_COLLECTIONS"].legacyCenters,
                ...doc.data()
            });
        }
        for (const doc of centersSnap.docs){
            centersMap.set(doc.id, {
                centerId: doc.id,
                source: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firestorePaths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FIRESTORE_COLLECTIONS"].centers,
                ...doc.data()
            });
        }
        const centerIds = Array.from(centersMap.keys());
        const adminRefs = centerIds.map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection("center_admins").doc(id));
        const adminSnaps = adminRefs.length ? await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].getAll(...adminRefs) : [];
        const adminMap = new Map();
        for (const snap of adminSnaps){
            if (snap.exists) adminMap.set(snap.id, snap.data());
        }
        const items = courtsSnap.docs.map((doc)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__23cec837._.js.map