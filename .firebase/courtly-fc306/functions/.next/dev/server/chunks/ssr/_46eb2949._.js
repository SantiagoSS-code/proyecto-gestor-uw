...
"[project]/app/backoffice/centers/[centerId]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BackofficeCenterDetailPage() {
    ...
    const load = async ()=>{
        try {
            setError(null);
            setLoading(true);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$backoffice$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["backofficeFetch"])(`/api/backoffice/centers/${centerId}`);
            setData(res);
        } catch (e) {
    ...
    const patch = async (payload)=>{
        try {
            setSaving(true);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$backoffice$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["backofficeFetch"])(`/api/backoffice/centers/${centerId}`, {
                method: "POST",
...
//# sourceMappingURL=_46eb2949._.js.map