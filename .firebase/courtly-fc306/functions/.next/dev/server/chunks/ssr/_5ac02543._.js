...
"[project]/lib/players.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createMinimalPlayerProfile(uid, email) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$firebase$2b$firestore$40$4$2e$10$2e$0_$40$firebase$2b$app$40$0$2e$14$2e$7$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$firebase$2b$firestore$40$4$2e$10$2e$0_$40$firebase$2b$app$40$0$2e$14$2e$7$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "players", uid), {
        uid,
...
"[project]/components/auth/login-players-form.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$players$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/players.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function LoginPlayersForm() {
    ...
    const handleAuthRedirect = async (uid, userEmail)=>{
        // Prevent double redirect
        if (redirectHandledRef.current) {
            console.info("[PlayersLogin] redirect already handled, skipping");
            return;
        }
        redirectHandledRef.current = true;
        console.info("[PlayersLogin] ========== AUTH REDIRECT START ==========");
        console.info("[PlayersLogin] user.uid:", uid);
        console.info("[PlayersLogin] user.email:", userEmail);
        try {
            const status = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$players$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPlayerOnboardingStatus"])(uid);
            console.info("[PlayersLogin] ========== ONBOARDING STATUS ==========");
            console.info("[PlayersLogin] docPath:", status.docPath);
            console.info("[PlayersLogin] exists:", status.exists);
            console.info("[PlayersLogin] onboardingCompleted:", status.onboardingCompleted);
            console.info("[PlayersLogin] redirectTo:", redirectTo);
            console.info("[PlayersLogin] DECISION: Login always skips onboarding -> Redirect to:", redirectTo);
            router.replace(redirectTo);
        } catch (err) {
            console.error("[PlayersLogin] Error during redirect logic:", err);
            router.replace("/players");
        }
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!authLoading && user && !redirectHandledRef.current) {
            handleAuthRedirect(user.uid, user.email);
        }
    }, [
        authLoading,
        user
    ...
    const handleEmailLogin = async (e)=>{
        ...
        try {
            ...
            await handleAuthRedirect(userCredential.user.uid, userCredential.user.email);
        } catch (error) {
    ...
    const handleGoogleLogin = async ()=>{
        ...
        try {
            const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$firebase$2b$auth$40$1$2e$12$2e$0_$40$firebase$2b$app$40$0$2e$14$2e$7$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GoogleAuthProvider"]();
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$firebase$2b$auth$40$1$2e$12$2e$0_$40$firebase$2b$app$40$0$2e$14$2e$7$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithPopup"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], provider);
            const idToken = await result.user.getIdToken();
            await createSessionCookie(idToken);
            await handleAuthRedirect(result.user.uid, result.user.email);
        } catch (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
        className: "w-full max-w-md backdrop-blur-sm bg-white/80 border-0 shadow-2xl",
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardDescription"], {
                                ...
                                children: "Inicia sesión para reservar, encontrar partidos y jugar más"
                            }, void 0, false, {
                                fileName: "[project]/components/auth/login-players-form.tsx",
                                lineNumber: 154,
                                columnNumber: 11
...
//# sourceMappingURL=_5ac02543._.js.map