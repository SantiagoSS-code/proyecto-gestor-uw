...
let authBackoffice: any = null;
let dbBackoffice: any = null;
...
try {
  ...
  authBackoffice = getAuth(app);
  dbBackoffice = getFirestore(app);
  ...
  console.error('Firebase backoffice initialization failed:', e);
}

export { authBackoffice, dbBackoffice }
